...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "FierceStukCloud_Mobile.Android.dll" comes first in this list. */
		"FierceStukCloud_Mobile.Android.dll",
		"FierceStukCloud_Mobile.dll",
		"FormsViewGroup.dll",
		...
		"FierceStukCloud_NetStandardLib.dll",
	};
